            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget p-lg">
                        <a href="{{ url('supervisor/payment-export') }} "
                            class="btn btn-sm btn-primary float-right">Exportar
                            Excel</a>
                            ...
                            <table class="table agente-payments-table">
                                ...
                                <tbody>
                                    ...
                                    <tr id="credit_{{$client->credit_id}}">
                                        ...
                                        <td>
                                            <a href="{{url('supervisor/summary-detail')}}?id_credit={{$client->credit_id}}&id_agent={{$id_agent}}"
                            ...
                            <table class="table agente-payments-table">
                                ...
                                <tbody>
                                    ...
                                    <tr id="credit_{{$client->credit_id}}">
                                        ...
                                        <td>
                                            <a href="{{url('admin/summary')}}?id_credit={{$client->credit_id}}&id_agent={{$id_agent}}"
                                                class="btn btn-info btn-xs"><i class="fa fa-history"></i> Ver</a>
                                        </td>
                                    </tr>
                                    @endif
