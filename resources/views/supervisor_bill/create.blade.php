                        ...
                        <div class="widget-body">
                            <form method="POST" action="{{url('supervisor/bill')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" required id="" cols="30"
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{url('supervisor/get-bills/create')}}"
                                        class="btn btn-info btn-block btn-md">Consultar</a>
                                    {{-- 
                                    <a href="{{url('supervisor/bill/')}}"
                                    class="btn btn-info btn-block btn-md">Consultar</a> --}}
                                </div>
                            </form>
