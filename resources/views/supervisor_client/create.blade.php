                ...
                <div class="col-md-12 col-lg-8 offset-lg-2">
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <form method="POST" action="{{url('supervisor/client')}}" class="supervisor-client"
                                ...
                                <div class="form-group">
                                    {{-- <a id="link_client_audit" class="btn btn-success btn-block" disabled
                                        href="{{url('supervisor/client')}}">Consultar</a> --}}
